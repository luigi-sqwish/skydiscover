"""SkyDiscover bridge for optimizing ALMA BabaIsAI memory implementations."""

from skydiscover.evaluation.alma_bridge import ALMA_BABAISAI_TASK, make_alma_benchmark_adapter


TASK_DESCRIPTOR = ALMA_BABAISAI_TASK
